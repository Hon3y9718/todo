...
class AppNavigationScreen extends GetWidget<AppNavigationController> {
  ...
  /// push the named route for the appScreen.
  onTapApp() {
    Get.toNamed(
      AppRoutes.appScreen,
    );
  ...
  /// Navigates to the clearAllDialogueScreen when the action is triggered.

  /// When the action is triggered, this function uses the [Get] package to
  /// push the named route for the clearAllDialogueScreen.
  onTapClearallDialogue() {
    Get.toNamed(
      AppRoutes.clearAllDialogueScreen,
    );
  }
  ...
  /// When the action is triggered, this function uses the [Get] package to
  /// push the named route for the infoScreen.
  onTapInfo() {
    Get.toNamed(
